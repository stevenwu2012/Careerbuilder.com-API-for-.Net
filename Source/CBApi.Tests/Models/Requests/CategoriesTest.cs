...
namespace Tests.com.careerbuilder.api.Requests
{
    ...
    public class CategoriesTest
    {
        ...
        public void Constructor_ThrowsException_OnEmptyDevKey()
        {
            try
            {
                CategoriesStub request = new CategoriesStub("", "api.careerbuilder.com");
                Assert.Fail();
            }
        ...
        public void Constructor_ThrowsException_OnNullDevKey()
        {
            try
            {
                CategoriesStub request = new CategoriesStub(null, "api.careerbuilder.com");
                Assert.Fail();
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void Constructor_ThrowsException_OnEmptyDomain()
        {
            try
            {
                CategoriesStub request = new CategoriesStub("DevKey", "");
                Assert.Fail();
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void Constructor_ThrowsException_OnNullDomain()
        {
            try
            {
                CategoriesStub request = new CategoriesStub("DevKey", null);
                Assert.Fail();
            }
            catch (ArgumentNullException ex)
            {
    ...
    public class CategoriesStub : Categories
    {
        ...
        public CategoriesStub(string key, string domain)
            : base(key, domain)
        {
